   ...
   public class ProcessData
    {
        ...
        public void DefineInterest(string input)
        {
            ...
            if (Double.Parse(result[2]) > 0)
            {
                ...
                {
                    // Replace the existing rule with the new interestRule
        ...
        public void CalculateInterest(string accountNumber, string date)
        {
            ...
            {
                // Replace the existing interest transaction with the new values
            ...
            {
                // Add interest transaction for the last day of the month
                ...
                // Replace the following code in the CalculateInterest method
